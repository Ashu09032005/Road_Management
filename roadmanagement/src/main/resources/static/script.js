...
function calculateRoute() {
    ...
    const disasterLat = parseFloat(document.getElementById("disLat").value);
    const disasterLon = parseFloat(document.getElementById("disLon").value);
    const disasterRadius = parseFloat(document.getElementById("disRadius").value);

    console.log("Sending disaster:", disasterLat, disasterLon, disasterRadius);
